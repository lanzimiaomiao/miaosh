...
if [ -n "$IP4" ]; then
    ...
    echo -e "hysteria2://${UUID}@${IP4}:443?sni=${DEST_DOMAIN}&insecure=0&allowInsecure=0&pinSHA256=${CERT_PIN}#Hysteria_V4"
...
if [ -n "$IP6" ]; then
    ...
    echo -e "hysteria2://${UUID}@[${IP6}]:443?sni=${DEST_DOMAIN}&insecure=0&allowInsecure=0&pinSHA256=${CERT_PIN}#Hysteria_V6"
